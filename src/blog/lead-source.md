---
title: Lead Source and Real Time Marketing Forms
pubDate: 2023-10-16
image:
    url: 'http://localhost:4321/src/assets/images/posts/ab-testing-in-customer-insights-journeys.jpg'
    alt: 'Lead Source and Real Time Marketing Forms'
description: |
  Optimize lead generation in Real Time Marketing. Resolve Lead Source issue with 5 steps for effective reporting.
tags: ["landing pages", "lead management"]
---
...
![Empty lead source field on Lead](/assets/images/blog/lead-source/Lead_source.png)
...
![A simple Lead Generation Form in Real Time Marketing](/assets/images/blog/lead-source/Lead_generation_form_real_time_marketing.png)

## Step 2

Look for the Lead Source field in the Fields section.

![Look for the Lead Source field](/assets/images/blog/lead-source/Lead_source_field_lookup.png)

## Step 3

Add the Lead Source field to your form.

![Lead Source field on Real Time Marketing Form](/assets/images/blog/lead-source/Lead_source_field_on_real_time_marketing_form.png)

## Step 4

Make the Lead Source field default value Landing page and make the field hidden.

![Set the value and make it hidden](/assets/images/blog/lead-source/Default_value_hidden_lead_source.png)

## Step 5

Your form is ready to go. From now on, the leads generated with this form, will have a Lead Source value of Landing page.

![Leads have a filled Lead Source](/assets/images/blog/lead-source/Filled_lead_source_on_lead.png)
