...
This event registration QR code can serve as a personal ticket to your event. This type of personalization is good to <a href="https://marketing-lab.nl/work/seven-tips-to-prevent-no-shows">improve your no-show rate</a>.
...
![Add QR Code to Email](/assets/images/blog/event-registration-qr-code-in-real-time-marketing-email/add-qr-code-to-email.png)
...
![Set the Event for the Event Registration QR Code to a Dynamic Field](/assets/images/blog/event-registration-qr-code-in-real-time-marketing-email/set_qr_code_to_dynamic_field.png)
...
![Set the Source of the Event to the Correct Attribute](/assets/images/blog/event-registration-qr-code-in-real-time-marketing-email/set_the_source_of_the_event.png)

## Result

This is what the final email looks like.

![The Final Design of the Email with the QR Code](/assets/images/blog/event-registration-qr-code-in-real-time-marketing-email/email_with_qr_code.png)
...
<source src="/assets/images/blog/event-registration-qr-code-in-real-time-marketing-email/how-to-create-dynamic-event-registration-qr-code.mp4" type="video/mp4">
</video>