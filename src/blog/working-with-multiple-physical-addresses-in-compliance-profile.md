...
![Dynamics Customer Insights - Journeys - Compliance Profile with Multiple Address Lines](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Dynamics-Customer-Insights-Journeys-Compliance-Profile-with-Multiple-Address-Lines.png)

However, take a look at the email—no custom fields! 😭

![Dynamics Customer Insights - Journeys - Compliance Profile Fields in Email](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Dynamics-Customer-Insights-Journeys-Compliance-Profile-Fields-in-Email.png)

Alright, let's try the *Other tables* option.

![Dynamics Customer Insights - Journeys - Compliance Profile Personalization](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Dynamics-Customer-Insights-Journeys-Compliance-Profile-Personalization.png)
...
![Dynamics Customer Insights - Journeys - Compliance Profile Select Record](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Customer-Insights-Journeys-Compliance-Profile-Personalization-Select-Record.png)
...
![Dynamics Customer Insights - Journeys - Compliance Profile Fields in Email](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Dynamics-Customer-Insights-Journeys-Brand-Profile-Personalization.png)
...
![Dynamics Customer Insights - Journeys - Company Address Field Warning](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Dynamics-Customer-Insights-Journeys-Company-Address-Field-Warning.png)
...
![Dynamics Customer Insights - Journeys - Physical Address in Content Block](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Dynamics-Customer-Insights-Journeys-Using-Physical-Address-in-Protected-Content-Block.png)
...
![Dynamics Customer Insights - Journeys - Content Block Responsiveness](../assets/images/posts/working-with-multiple-physical-addresses-in-compliance-profile/Dynamics-Customer-Insights-Journeys-Content-Block-Responsiveness.jpg)
