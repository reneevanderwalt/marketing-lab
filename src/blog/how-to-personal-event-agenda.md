...
When organizing events with multiple sessions, you want to ensure that registrants can create their own agendas. I have already <a href="https://renee.vanderwalt.eu/blog/session-registrations-how-to">written a post</a> on how to set up the event, but now I will look into communicating to registrants about their agendas. You can also check out the <a href="#how-to-video">video</a> at the bottom of this page.

Now, let's take a look at how to add a personal agenda to these emails, so you can increase engagement and <a href="https://renee.vanderwalt.eu/blog/seven-tips-to-prevent-no-shows">lower your no-show rate</a>.
...
![Add a list in the personalize menu of the meail](../assets/images/posts/how-to-create-personalized-agenda/Add_list_to_email.png)

Set the list entity to session registrations from the event registration entity.

![Select the session registration entity from the event registration entity](../assets/images/posts/how-to-create-personalized-agenda/Select_Session_Registration_entity.png)
...
![Set up the list personalization based on session registrations or sessions](../assets/images/posts/how-to-create-personalized-agenda/List_item.jpg)
...
![The list code copied into the email](../assets/images/posts/how-to-create-personalized-agenda/List_copied_in_email.png)

## Results

This is what the email looks like:

![Final email](../assets/images/posts/how-to-create-personalized-agenda/Final_email_result.png)

## How to Video

<video width="100%" controls>
<source src="../assets/images/posts/how-to-create-personalized-agenda/how-to-create-personalized-agenda.mp4" type="video/mp4">
</video>