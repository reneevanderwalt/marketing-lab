...
This Add-to-Calendar link  is easy to add, but can make a big improvement on your <a href="https://renee.vanderwalt.eu/blog/seven-tips-to-prevent-no-shows">no-show rate</a>. No time to waste!
...
![Calendar content](../assets/images/posts/how-to-add-to-calendar/Calendar_content.png)
...
![Create your email](../assets/images/posts/how-to-add-to-calendar/Creat_your_email.png)

## Step 2 - Create an "Add to Calendar" Link

Ensure the URL type is an "Add to Calendar" link.

![Make the button an Add to calendar button](../assets/images/posts/how-to-add-to-calendar/Button_link_to.png)

## Step 3 - Make the Link Dynamic

Set the field ‘Select Event/Event registration’ to **From other source**.

![Set the Event to Other source](../assets/images/posts/how-to-add-to-calendar/From_other_source.png)
...
![Select the correct field](../assets/images/posts/how-to-add-to-calendar/Select_the_correct_field.png)
...
![Create the Journey](../assets/images/posts/how-to-add-to-calendar/Final_journey.png)

## Results

And here you can see the results in your registrants' calendar!

![Calendar item in Outlook](../assets/images/posts/how-to-add-to-calendar/Calendar_item_outlook.png)
...
<source src="../assets/images/posts/how-to-add-to-calendar/How-to-add-to-calendar-link.mp4" type="video/mp4">
</video>